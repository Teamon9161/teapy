...
use tools::{arr_ext_tool, expand_trait_ext, pre_impl_parser};
...
pub fn arr_agg2_ext(attr: TokenStream, input: TokenStream) -> TokenStream {
    arr_ext_tool(
        attr,
        input,
        methods_impl::reduce2_nd_method,
        None,
        MethodType::Reduce,
    )
}
...
pub fn arr_inplace_ext(attr: TokenStream, input: TokenStream) -> TokenStream {
    arr_ext_tool(
        attr,
        input,
        methods_impl::inplace_nd_method,
        None,
        MethodType::Inplace,
    )
}
