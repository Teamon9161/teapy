...
def test_calc_ret_single():
    ...
    # time5: 换月
    #   平仓并重新开仓的手续费(以新的开仓价近似计算手续费): 1046 * 2 * 220 * 10 * 0.0003=1380.72
    #   当期损益： (226 - 220) * -1046 * 10 = -62760
    #   1067027.021 - 62760 - 1380.72 = 1002886.301
    # time6:
    #   平仓手续费： -1046 * 226 * 10 * 0.0003 = -709.188
    #   损益： -1046 * (226 - 226) * 10 = 0
    #   1002886.301 - 709.188 = 1002177.113
