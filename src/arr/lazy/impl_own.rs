    ...
    T: ExprElement + 'a,
{
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().sqrt()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().cbrt()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().ln()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().ln_1p()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().log2()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().log10()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().exp()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().exp2()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().exp_m1()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().acos()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().asin()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().atan()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().sin()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().cos()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().tan()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().ceil()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().floor()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().fract()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().trunc()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().is_finite()).into())
    }
    ...
    where
        T: Number,
    {
        self.chain_view_f(move |arr| arr.mapv(|v| v.f64().is_infinite()).into())
    }
    ...
    pub fn ndim(self) -> Expr<'a, usize> {
        self.chain_view_f(move |arr| arr.ndim().into())
    }
...
impl<'a> Expr<'a, DateTime> {
    pub fn strftime(self, fmt: Option<String>) -> Expr<'a, String> {
        self.chain_view_f(move |arr| arr.map(move |dt| dt.strftime(fmt.clone())).into())
    }
