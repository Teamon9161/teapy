    ...
    S: Data<Elem = T>,
{
    impl_reduce_nd!(
        ...
        #[inline]
        pub fn count_notnan_1d(&self) -> usize
        {T: Number,}
        {
    ...
    impl_reduce_nd!(
        ...
        #[inline]
        pub fn count_nan_1d(&self) -> usize
        {T: Number,}
        {
    ...
    impl_reduce_nd!(
        ...
        pub fn quantile_1d(&self, q: f64, method: Option<&str>) -> f64
        {T: Number,}
        {
            ...
            if method == "linear" {
                ...
                vi + (vj - vi) * fraction
            } else if method == "lower" { // i
                vi
            } else if method == "higher" { // j
                vj
            } else if method == "midpoint" { // (i + j) / 2.
                (vi + vj) / 2.
            } else {
                panic!("Not supported quantile method: {}", method);
            }
        }
    );
    ...
    impl_reduce_nd!(
        ...
        {T: Number,}
        {
            self.quantile_1d(0.5, Some("linear"))
        }
    );
